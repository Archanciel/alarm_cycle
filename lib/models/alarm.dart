...
class Alarm {
  ...
  factory Alarm.fromJson(Map<String, dynamic> json) {
    return Alarm(
      ...
      startAlarmDateTime: DateTimeParser.englishDateTimeFormat.parse(json['startAlarmDateTimeStr']),
    );
  }
  ...
  Map<String, dynamic> toJson() => {
        ...
        'startAlarmDateTimeStr': DateTimeParser.englishDateTimeFormat.format(startAlarmDateTime),
      };
}
